package com.thanhtrt.ungdungquanlykhachhangquanlytinh.controller;
...
public class CustomerController {
    ...
    public ModelAndView listCustomers(@RequestParam("s") Optional<String> s, @PageableDefault(size = 10) Pageable pageable, Model model) {
